export const generalConfig: GeneralConfigType = {
	...
	name: 'EPGP Bot', // the name of your bot
	...
	devs: [process.env['BOT_OWNER_ID']], // discord IDs of the devs that are working on the bot (you don't have to put the owner's id here)
